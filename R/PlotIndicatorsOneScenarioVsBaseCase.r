...
#                legend_labels = simpleregionNamesForTheseModels, plotfile=paste("IndicatorPlotA_", thisRunName, ".pdf", sep=""), standardized = TRUE, colvec = coloursForTheseModels)
...
#                legend_labels = simpleregionNamesForTheseModels,plotfile=paste("IndicatorPlotB_", thisRunName, ".pdf", sep=""), standardized = TRUE, colvec = coloursForTheseModels)
...
# PLOT Catch and Exploitation Rate INDICATORS THAT Reflect Forage Concerns
...
# Note need to go into Plot indicators and change pdf() to png(): 
# PLOT Catch and Exploitation Rate INDICATORS THAT Reflect Forage Concerns
